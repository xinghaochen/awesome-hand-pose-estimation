python src/compute_error.py icvl max-frame\
    ...
    Ren-4x6x6   results/icvl/ICIP17_ICVL_Guo_REN_4x6x6.txt\
    Ren-9x6x6   results/icvl/arXiv17_ICVL_Guo_REN_9x6x6.txt\
	Pose-REN   results/icvl/arXiv17_ICVL_Pose_REN.txt\
	DenseReg   results/icvl/arXiv17_ICVL_denseReg.txt\
