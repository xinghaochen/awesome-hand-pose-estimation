...
|------|------|------|------|------|------|------|------|------|----------------|
|[OneHand10K](http://cims.nyu.edu/~tompson/NYU_Hand_Pose_Dataset.htm) | 2019 | R | C | No | 21 | 3rd | - | 10k/1.3k | Mask-pose Cascaded CNN for 2D Hand Pose Estimation from Single Color Image, TCSVT 2019 [\[PDF\]](https://yangangwang.com/papers/WANG-MCC-2018-10.pdf)|
